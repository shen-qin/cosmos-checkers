...
import ShenQinCheckersShenqinCheckersCheckers from './shen-qin/checkers/shenqin.checkers.checkers'
...
export default { 
  ...
  ShenQinCheckersShenqinCheckersCheckers: load(ShenQinCheckersShenqinCheckersCheckers, 'shenqin.checkers.checkers'),
